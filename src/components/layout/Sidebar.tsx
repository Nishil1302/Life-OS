...
import {
  ...
  BarChart2, FileText, Brain, Timer, Settings, Moon, Sun, Plus, Zap
} from 'lucide-react'
...
export default function Sidebar() {
  ...
  const { darkMode, toggleDarkMode, setQuickAdd } = useUIStore()
  ...
  return (
    <aside className="sidebar fixed left-0 top-0 h-screen w-60 flex flex-col z-40 transition-all duration-300">
      {/* Logo */}
